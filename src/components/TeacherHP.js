...
function TeacherHP() {
  return (
    <div className="homepage-container">
      ...
      <img src={profile1} alt="Profile" className="profile-picture" />
      ...
      <div className='horizontal-line'></div>
       ...
       <div className='track'><h1>TRACK</h1> <Link to="/Attendance" className="attendance-button"><h3>ATTENDANCE SHEET</h3></Link></div>
